 ...
 * needed because a few teams' primary colors are light (Steelers gold,
 * Saints gold) and most are dark, so a single hardcoded text color would be
 * unreadable on some of them. Uses the standard relative-luminance formula.
 */
